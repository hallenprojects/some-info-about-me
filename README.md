...
![Infrastructure](https://img.shields.io/badge/Planning-5D_Infrastructure-orange?style=for-the-badge)

---

### 🌟 Proiecte Relevante:
- **5D Gaming Room Design:** Planificare și execuție de infrastructură hardware și design tehnic.
- **Dynamic Web Panel:** Sistem complex de administrare servere (CS 1.6) cu PHP & SQL.
- **AI ChatBot:** Interfață web Flask integrată cu Google Gemini API.
- **CS 1.6 Skin System:** Extensie C++ pentru manipularea datelor în timp real.
...
- 📧 Email: [ganeaadi4@gmail.com](mailto:ganeaadi4@gmail.com)
- 📍 Locație: Craiova, România

---
*“Quality first. Modern technology. Client-focused.”*
